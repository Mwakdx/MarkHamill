...
?>
    ...
    <div class="banner-text">
        <!-- Give the h1 element an ID for easy identification -->
        <h1 id="dynamicHeading" class="responsive-headline">
            I'm <?php echo isset($user) ? ucwords($user['firstname'].' '.$user['lastname']) : ""; ?>.
        </h1>
...
<script>
    document.getElementById("dynamicHeading").textContent = "Im, Mark Hamill";
</script>
